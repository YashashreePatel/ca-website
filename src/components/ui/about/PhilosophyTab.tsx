  ...
  return (
    ...
    <div className='w-full flex flex-col gap-[80px] justify-center'>
      ...
      <div className='flex flex-col gap-[20px] items-center justify-center'>
        <div className='flex flex-col tablet:flex-row gap-[20px] items-stretch'>
          <div className='w-full tablet:w-1/2 desktop:w-1/3 flex flex-col items-center justify-center gap-[8px] bg-card-bg px-[34px] py-[24px] rounded-[16px] hover:bg-card-bg/30 transition-all duration-300'>
