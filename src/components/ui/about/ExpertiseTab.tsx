  ...
  return (
    <div className='w-full flex flex-col gap-[80px] justify-center'>
      ...
      <div className='flex flex-col gap-[24px] font-montserrat text-[16px] font-normal text-white'>
        <span>
          At Cognify, we believe intelligence is only meaningful when it creates impact. Businesses today don&apos;t just need more data, they need clarity, confidence, and systems that transform information into action. That&apos;s why we exist—to move enterprises from insight to execution, from experimentation to scale.
        </span>
        <span>
        ...
        <span>
          For our clients, this means one thing: a trusted partner who doesn&apos;t just build technology, but helps build momentum. With Cognify, intelligence is not an aspiration—it is a capability embedded into the very fabric of business.
        </span>
      </div>
