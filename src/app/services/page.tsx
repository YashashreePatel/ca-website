...
export default async function Services() {
  ...
  return (
    <div className={`w-full px-[24px] pb-[80px] pt-[180px] tablet:px-[60px] desktop:px-[100px] bg-black`}>
      <div className='w-full flex flex-col gap-[80px] items-center justify-center'>
        <div className='w-full desktop:w-[900px] flex flex-col gap-[16px] justify-center items-center'>
